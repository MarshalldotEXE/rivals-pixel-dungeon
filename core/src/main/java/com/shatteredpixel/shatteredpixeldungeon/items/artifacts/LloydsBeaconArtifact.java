...
//TO-DO: kill this class and move all necessary code to another since the only purpose of this class is to ensure distortion trap works
public class LloydsBeaconArtifact extends Artifact {
	...
	public void execute( Hero hero, String action ) {
		...
		if (action == AC_SET || action == AC_RETURN) {
			...
			if (Dungeon.bossLevel()) {
				hero.spend( LloydsBeaconArtifact.TIME_TO_USE );
	...
	protected CellSelector.Listener zapper = new  CellSelector.Listener() {
								...
								public void call() {
									if (ch != null) {
										...
										if (pos == -1 || Dungeon.bossLevel()) {
											...
											GLog.w( Messages.get(LloydsBeaconArtifact.class, "tele_fail") );
		...
		public String prompt() {
			return Messages.get(LloydsBeaconArtifact.class, "prompt");
		}
	};
