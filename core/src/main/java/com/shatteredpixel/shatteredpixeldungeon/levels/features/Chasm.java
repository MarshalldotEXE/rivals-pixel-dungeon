...
import com.shatteredpixel.shatteredpixeldungeon.items.potions.exotic.PotionOfFeatherFall;
...
public class Chasm {
	...
	public static void heroLand() {
		...
		PotionOfFeatherFall.FeatherBuff b = hero.buff(PotionOfFeatherFall.FeatherBuff.class);
